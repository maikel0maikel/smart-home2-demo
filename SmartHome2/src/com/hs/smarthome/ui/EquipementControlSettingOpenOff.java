...
public class EquipementControlSettingOpenOff extends Activity implements View.OnClickListener{
	
	private Button panel_kg_bt1;
	private Button panel_kg_bt2;
	private Button panel_kg_bt3;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.equipement_control_panel_openoff);
		...
		panel_kg_bt3 = (Button)findViewById(R.id.panel_kg_bt3);
		
		this.panel_kg_bt1.setOnClickListener(this);
		this.panel_kg_bt2.setOnClickListener(this);
		this.panel_kg_bt3.setOnClickListener(this);
	}
	...
	public void onClick(View paramView) {
		...
		case R.id.panel_kg_bt2:
			...
			break;	
		case R.id.panel_kg_bt3:
			reqIntent =new Intent(this, EquipementControlPanelSettingDialog.class);
			reqIntent.putExtra("homeItem",homeItem);
			reqIntent.putExtra("clickButtonID", R.id.panel_kg_bt3);
			break;
