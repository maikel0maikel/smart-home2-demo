...
public class AlarmSettingNameDialog extends Activity implements View.OnClickListener{
	...
	public void onClick(View paramView) {
		switch (paramView.getId()) {
			case R.id.Ok:
				...
				Intent mIntent = new Intent(AlarmSettingNameDialog.this, AlarmSettingActivity.class);
