...
import com.nd.hilauncherdev.myphone.phonehelper.CallHelperListener;
		...
		try {
			...
			while ((str = bufferedreader.readLine()) != null) {
				...
				if (str.contains("GET_CURRENT_CALLS")){
					Log.i("CallOutStateCheckThreadIn", Thread.currentThread().getName() + ":" + str);
				}else{
					Log.i("CallOutStateCheckThreadOut", Thread.currentThread().getName() + ":" + str);
				}
